Public Class Spring
    ...
    Public Sub Draw(g As Graphics, tint As Color)
        Using p As New Pen(tint)
            g.DrawLine(p, Me.Top.Center.ToPointF, Me.Bottom.Center.ToPointF)
        End Using
    End Sub

    Public Function GetByWeight() As Particle
        If (Me.Top.Mass > Me.Bottom.Mass) Then Return Me.Top
        Return Me.Bottom
    End Function
